...
function addtocart(){
    console.log("ddd")
   var item={
    price : document.querySelector(".price").textContent.replace(/\$/g, ''),
   quantity : document.querySelector("#valuee").textContent,
   total: document.querySelector(".price").textContent.replace(/\$/g, '')*document.querySelector("#valuee").textContent ,
